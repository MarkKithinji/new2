...
f_name = StringVar()
f_name = Entry(window,width=20,bg= "light grey",borderwidth=3, textvariable = f_name)
f_name.place(x=400,y=200)


s_name = StringVar()
s_name = Entry(window,width=20,bg= "light grey",borderwidth=3, textvariable= s_name)
